...
public class AcmCasConfiguration {
    ...
    public ServiceProperties serviceProperties() {
        ...
        serviceProperties.setService(acmCasProperties.getAppServicePrefix() + "home");
    ...
    public SingleSignOutFilter singleSignOutFilter() {
        ...
        outFilter.setLogoutCallbackPath(acmCasProperties.getCasServerPrefix());
